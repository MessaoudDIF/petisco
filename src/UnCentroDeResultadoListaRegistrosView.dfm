object CentroDeResultadoListaRegistrosView: TCentroDeResultadoListaRegistrosView
  Left = 422
  Top = 175
  ...
  object pnlFiltro: TPanel
    ...
    ParentBackground = False
    TabOrder = 1
    object EdtCentroDeResultado: TEdit
      Left = 24
      Top = 8
      Width = 585
      Height = 19
      ...
      ParentFont = False
      TabOrder = 0
      OnChange = EdtCentroDeResultadoChange
    end
  end
  object gCentrosResultado: TJvDBUltimGrid
    Left = 0
    Top = 104
    Width = 685
    Height = 462
    ...
    TitleFont.Style = []
    OnDblClick = gCentrosResultadoDblClick
