object ContasReceberListaRegistrosView: TContasReceberListaRegistrosView
  Left = 468
  Top = 225
  ...
  object pnlFiltro: TPanel
    ...
    object EdtContaReceber: TEdit
      ...
      ParentFont = False
      TabOrder = 0
      OnChange = EdtContaReceberChange
    end
  end
  object gContasReceber: TJvDBUltimGrid
    Left = 0
    Top = 104
    Width = 733
    Height = 508
    ...
    TitleFont.Style = []
    OnDblClick = gContasReceberDblClick
