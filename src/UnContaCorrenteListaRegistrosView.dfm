object ContaCorrenteListaRegistrosView: TContaCorrenteListaRegistrosView
  Left = 624
  Top = 181
  ...
  object pnlFiltro: TPanel
    ...
    object EdtContaCorrente: TEdit
      ...
      ParentFont = False
      TabOrder = 0
      OnChange = EdtContaCorrenteChange
    end
  end
  object gContasCorrentes: TJvDBUltimGrid
    Left = 0
    Top = 104
    Width = 862
    Height = 533
    ...
    TitleFont.Style = []
    OnDblClick = gContasCorrentesDblClick
